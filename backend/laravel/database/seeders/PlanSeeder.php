...
class PlanSeeder extends Seeder
{
 public function run(): void
 {
  DB::table('plans')->upsert([
   ['slug'=>'trial','name'=>'Free Trial','monthly_price'=>0,'active_listing_limit'=>1,'direct_deal_limit'=>1,'active'=>1],
  ...
  ], ['slug'], ['name','monthly_price','active_listing_limit','direct_deal_limit','active']);
 }
}
